if [ -f /sys/hypervisor/uuid ] && [ `head -c 3 /sys/hypervisor/uuid` == ec2 ]; then
    export GLOVE_INDEX_LOC="/home/ubuntu/6B.50_idx.pkl"
    ...
    export GLOVE_INDEX_LOC="/data5/shashank2000/6B.50_idx.pkl"
    export GLOVE_LOC="/home/shashank2000/synced/project/emb_weights_1.data"
